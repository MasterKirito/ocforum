...
class ControllerModuleOcforum extends Controller {
	...
	public function index() { 
		...
		if (isset($this->request->post["ocforum_module"])) {
			$this->data["modules"] = $this->request->post["ocforum_module"];
		} elseif ($this->config->get("ocforum_module")) { 
			$this->data["modules"] = $this->config->get("ocforum_module");
		}	
