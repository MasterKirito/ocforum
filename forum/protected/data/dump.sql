...
MySQL - 5.1.63-0ubuntu0.11.04.1 : Database - oclatest
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`oclatest` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `banner`(`banner_id`,`name`,`status`) values (6,'HP Products',1),(7,'Samsung Tab',1),(8,'Manufacturers',1);
...
insert  into `banner_image_description`(`banner_image_id`,`language_id`,`banner_id`,`title`) values (54,1,7,'Samsung Tab 10.1'),(77,1,6,'HP Banner'),(75,1,8,'HTC'),(74,1,8,'Canon'),(73,1,8,'Apple'),(72,1,8,'Palm'),(71,1,8,'Sony'),(76,1,8,'Hewlett-Packard');
...
insert  into `category_to_store`(`category_id`,`store_id`) values (17,0),(18,0),(20,0),(24,0),(25,0),(26,0),(27,0),(28,0),(29,0),(30,0),(31,0),(32,0),(33,0),(34,0),(35,0),(36,0),(37,0),(38,0),(39,0),(40,0),(41,0),(42,0),(43,0),(44,0),(45,0),(46,0),(47,0),(48,0),(49,0),(50,0),(51,0),(52,0),(53,0),(54,0),(55,0),(56,0),(57,0),(58,0);
...
insert  into `core_discussions`(`id`,`title`,`text`,`category_id`,`date`,`status`,`user_id`,`views_count`) values (2,'test','testt test teste etst teste',1,'2012-05-26 22:59:23',1,1,7),(3,'Test2','Test2 Test2 Test2 Test2 Test2 Test2',1,'2012-05-27 15:26:40',1,1,4),(4,'Тест 3','Тест 3 Тест 3 Тест 3 Тест 3',1,'2012-05-27 19:42:17',1,1,3),(5,'Новый пост','Пост в категории №2',2,'2012-06-03 21:16:12',1,1,148);
...
insert  into `core_posts`(`id`,`text`,`discussion_id`,`date`,`user_id`) values (1,'test test2',2,'2012-05-27 21:25:03',1),(2,'Еще один коммнатрий',4,'2012-06-03 18:10:46',1),(3,'добавим поддержку маркдаун',4,'2012-06-03 18:11:14',1),(4,'Нужно проверить пагинацию',3,'2012-06-03 18:24:48',1),(5,'Новый комментарий',5,'2012-06-03 21:19:23',1),(6,'фывфыв',5,'2012-06-03 21:42:17',1),(7,'ываыва',5,'2012-06-03 21:42:21',1),(8,'ываыва',5,'2012-06-03 21:42:24',1),(9,'авпвап',5,'2012-06-03 21:42:28',1),(10,'вапвап',5,'2012-06-03 21:42:32',1),(11,'впвапывап',5,'2012-06-03 21:42:37',1),(12,'впывап',5,'2012-06-03 21:42:41',1),(13,'фывфыв',5,'2012-06-03 21:49:22',1),(15,'вапрвапр',5,'2012-06-03 21:49:31',1),(16,'вапрвапр',5,'2012-06-03 21:49:35',1),(17,'апрвапрвп',5,'2012-06-03 21:49:40',1),(18,'This is a twelve column section in a row. Each of these includes a div.panel element so you can see where the columns are - it`s not required at all for the grid.',5,'2012-06-03 21:49:47',1),(19,'This is a twelve column section in a row. Each of these includes a div.panel element so you can see where the columns are - it`s not required at all for the grid.',5,'2012-06-03 21:50:00',1),(20,'This is a twelve column section in a row. Each of these includes a div.panel element so you can see where the columns are - it`s not required at all for the grid.',5,'2012-06-03 21:50:08',1),(21,'This is a twelve column section in a row. Each of these includes a div.panel element so you can see where the columns are - it`s not required at all for the grid.',5,'2012-06-03 21:50:18',1),(24,'test',5,'2012-06-03 22:50:34',1),(25,'sdfsdfsdf',5,'2012-06-03 22:51:23',1),(27,'sdfsdfsdf',5,'2012-06-03 22:54:42',1);
...
insert  into `currency`(`currency_id`,`title`,`code`,`symbol_left`,`symbol_right`,`decimal_place`,`value`,`status`,`date_modified`) values (1,'Pound Sterling','GBP','£','','2',0.63510001,1,'2012-07-29 21:53:13'),(2,'US Dollar','USD','$','','2',1.00000000,1,'2012-07-29 21:53:13'),(3,'Euro','EUR','','€','2',0.81140000,1,'2012-07-29 21:53:13');
...
/*Data for the table `customer_ip_blacklist` */
...
insert  into `extension`(`extension_id`,`type`,`code`) values (23,'payment','cod'),(22,'total','shipping'),(57,'total','sub_total'),(58,'total','tax'),(59,'total','total'),(410,'module','banner'),(426,'module','carousel'),(390,'total','credit'),(387,'shipping','flat'),(349,'total','handling'),(350,'total','low_order_fee'),(389,'total','coupon'),(413,'module','category'),(411,'module','affiliate'),(408,'module','account'),(393,'total','reward'),(398,'total','voucher'),(407,'payment','free_checkout'),(427,'module','featured'),(419,'module','slideshow');
...
insert  into `geo_zone`(`geo_zone_id`,`name`,`description`,`date_modified`,`date_added`) values (3,'UK VAT Zone','UK VAT','2010-02-26 22:33:24','2009-01-06 23:26:25'),(4,'UK Shipping','UK Shipping Zones','2010-12-15 15:18:13','2009-06-23 01:14:53');
...
insert  into `layout`(`layout_id`,`name`) values (1,'Home'),(2,'Product'),(3,'Category'),(4,'Default'),(5,'Manufacturer'),(6,'Account'),(7,'Checkout'),(8,'Contact'),(9,'Sitemap'),(10,'Affiliate'),(11,'Information');
...
insert  into `layout_route`(`layout_route_id`,`layout_id`,`store_id`,`route`) values (30,6,0,'account'),(17,10,0,'affiliate/'),(29,3,0,'product/category'),(26,1,0,'common/home'),(20,2,0,'product/product'),(24,11,0,'information/information'),(22,5,0,'product/manufacturer'),(23,7,0,'checkout/'),(31,8,0,'information/contact');
...
insert  into `manufacturer`(`manufacturer_id`,`name`,`image`,`sort_order`) values (5,'HTC','data/htc_logo.jpg',0),(6,'Palm','data/palm_logo.jpg',0),(7,'Hewlett-Packard','data/hp_logo.jpg',0),(8,'Apple','data/apple_logo.jpg',0),(9,'Canon','data/canon_logo.jpg',0),(10,'Sony','data/sony_logo.jpg',0);
...
insert  into `option`(`option_id`,`type`,`sort_order`) values (1,'radio',2),(2,'checkbox',3),(4,'text',4),(5,'select',1),(6,'textarea',5),(7,'file',6),(8,'date',7),(9,'time',8),(10,'datetime',9),(11,'select',1),(12,'date',1);
...
insert  into `option_description`(`option_id`,`language_id`,`name`) values (1,1,'Radio'),(2,1,'Checkbox'),(4,1,'Text'),(6,1,'Textarea'),(8,1,'Date'),(7,1,'File'),(5,1,'Select'),(9,1,'Time'),(10,1,'Date &amp; Time'),(12,1,'Delivery Date'),(11,1,'Size');
...
insert  into `option_value`(`option_value_id`,`option_id`,`image`,`sort_order`) values (43,1,'',3),(32,1,'',1),(45,2,'',4),(44,2,'',3),(42,5,'',4),(41,5,'',3),(39,5,'',1),(40,5,'',2),(31,1,'',2),(23,2,'',1),(24,2,'',2),(46,11,'',1),(47,11,'',2),(48,11,'',3);
...
insert  into `option_value_description`(`option_value_id`,`language_id`,`option_id`,`name`) values (43,1,1,'Large'),(32,1,1,'Small'),(45,1,2,'Checkbox 4'),(44,1,2,'Checkbox 3'),(31,1,1,'Medium'),(42,1,5,'Yellow'),(41,1,5,'Green'),(39,1,5,'Red'),(40,1,5,'Blue'),(23,1,2,'Checkbox 1'),(24,1,2,'Checkbox 2'),(48,1,11,'Large'),(47,1,11,'Medium'),(46,1,11,'Small');
...
/*Data for the table `order_download` */
...
/*Data for the table `order_fraud` */
...
/*Table structure for table `order_misc` */

DROP TABLE IF EXISTS `order_misc`;

CREATE TABLE `order_misc` (
  `order_id` int(11) NOT NULL,
...
insert  into `product`(`product_id`,`model`,`sku`,`upc`,`location`,`quantity`,`stock_status_id`,`image`,`manufacturer_id`,`shipping`,`price`,`points`,`tax_class_id`,`date_available`,`weight`,`weight_class_id`,`length`,`width`,`height`,`length_class_id`,`subtract`,`minimum`,`sort_order`,`status`,`date_added`,`date_modified`,`viewed`) values (28,'Product 1','','','',939,7,'data/htc_touch_hd_1.jpg',5,1,'100.0000',200,9,'2009-02-03','146.40000000',2,'0.00000000','0.00000000','0.00000000',1,1,1,0,1,'2009-02-03 16:06:50','2011-09-30 01:05:39',0),(29,'Product 2','','','',999,6,'data/palm_treo_pro_1.jpg',6,1,'279.9900',0,9,'2009-02-03','133.00000000',2,'0.00000000','0.00000000','0.00000000',3,1,1,0,1,'2009-02-03 16:42:17','2011-09-30 01:06:08',0),(30,'Product 3','','','',7,6,'data/canon_eos_5d_1.jpg',9,1,'100.0000',0,9,'2009-02-03','0.00000000',1,'0.00000000','0.00000000','0.00000000',1,1,1,0,1,'2009-02-03 16:59:00','2011-09-30 01:05:23',0),(31,'Product 4','','','',1000,6,'data/nikon_d300_1.jpg',0,1,'80.0000',0,9,'2009-02-03','0.00000000',1,'0.00000000','0.00000000','0.00000000',3,1,1,0,1,'2009-02-03 17:00:10','2011-09-30 01:06:00',0),(32,'Product 5','','','',999,6,'data/ipod_touch_1.jpg',8,1,'100.0000',0,9,'2009-02-03','5.00000000',1,'0.00000000','0.00000000','0.00000000',1,1,1,0,1,'2009-02-03 17:07:26','2011-09-30 01:07:22',0),(33,'Product 6','','','',1000,6,'data/samsung_syncmaster_941bw.jpg',0,1,'200.0000',0,9,'2009-02-03','5.00000000',1,'0.00000000','0.00000000','0.00000000',2,1,1,0,1,'2009-02-03 17:08:31','2011-09-30 01:06:29',0),(34,'Product 7','','','',1000,6,'data/ipod_shuffle_1.jpg',8,1,'100.0000',0,9,'2009-02-03','5.00000000',1,'0.00000000','0.00000000','0.00000000',2,1,1,0,1,'2009-02-03 18:07:54','2011-09-
6.jpg',0),(2325,49,'data/samsung_tab_5.jpg',0),(2324,49,'data/samsung_tab_4.jpg',0),(2323,49,'data/samsung_tab_3.jpg',0),(2322,49,'data/samsung_tab_2.jpg',0),(2317,42,'data/canon_logo.jpg',0),(2316,42,'data/hp_1.jpg',0),(2315,42,'data/compaq_presario.jpg',0),(2314,42,'data/canon_eos_5d_1.jpg',0),(2313,42,'data/canon_eos_5d_2.jpg',0);
...
insert  into `product_option`(`product_option_id`,`product_id`,`option_id`,`option_value`,`required`) values (224,35,11,'',1),(225,47,12,'2011-04-22',1),(223,42,2,'',1),(217,42,5,'',1),(209,42,6,'',1),(218,42,1,'',1),(208,42,4,'test',1),(219,42,8,'2011-02-20',1),(222,42,7,'',1),(221,42,9,'22:25',1),(220,42,10,'2011-02-20 22:25',1),(226,30,5,'',1);
...
insert  into `product_related`(`product_id`,`related_id`) values (40,42),(41,42),(42,40),(42,41);
...
insert  into `product_reward`(`product_reward_id`,`product_id`,`customer_group_id`,`points`) values (516,42,6,10),(515,42,8,100),(520,47,6,30),(519,47,8,300),(380,28,6,400),(379,28,8,400),(330,43,6,60),(329,43,8,600),(340,29,6,0),(339,29,8,0),(344,48,6,0),(343,48,8,0),(336,40,6,0),(335,40,8,0),(540,30,6,20),(539,30,8,200),(332,44,6,70),(331,44,8,700),(334,45,6,80),(333,45,8,800),(337,31,8,0),(338,31,6,0),(426,35,6,0),(425,35,8,0),(345,33,8,0),(346,33,6,0),(347,46,8,0),(348,46,6,0),(546,41,6,0),(545,41,8,0),(351,36,8,0),(352,36,6,0),(353,34,8,0),(354,34,6,0),(355,32,8,0),(356,32,6,0),(522,49,6,1000),(521,49,8,1000);
...
insert  into `product_special`(`product_special_id`,`product_id`,`customer_group_id`,`priority`,`price`,`date_start`,`date_end`) values (419,42,8,1,'90.0000','0000-00-00','0000-00-00'),(439,30,8,2,'90.0000','0000-00-00','0000-00-00'),(438,30,8,1,'80.0000','0000-00-00','0000-00-00');
...
insert  into `product_tag`(`product_tag_id`,`product_id`,`language_id`,`tag`) values (341,42,1,'test 1'),(342,42,1,'test 2');
...
insert  into `product_to_category`(`product_id`,`category_id`) values (28,20),(28,24),(29,20),(29,24),(30,20),(30,33),(31,33),(32,34),(33,20),(33,28),(34,34),(35,20),(36,34),(40,20),(40,24),(41,27),(42,20),(42,28),(43,18),(43,20),(44,18),(44,20),(45,18),(46,18),(46,20),(47,18),(47,20),(48,20),(48,34),(49,57);
...
insert  into `product_to_store`(`product_id`,`store_id`) values (28,0),(29,0),(30,0),(31,0),(32,0),(33,0),(34,0),(35,0),(36,0),(40,0),(41,0),(42,0),(43,0),(44,0),(45,0),(46,0),(47,0),(48,0),(49,0);
...
insert  into `tax_class`(`tax_class_id`,`title`,`description`,`date_added`,`date_modified`) values (9,'Taxable Goods','Taxed Stuff','2009-01-06 23:21:53','2011-09-23 14:07:50'),(10,'Downloadable Products','Downloadable','2011-09-21 22:19:39','2011-09-22 10:27:36');
...
insert  into `tax_rate`(`tax_rate_id`,`geo_zone_id`,`name`,`rate`,`type`,`date_added`,`date_modified`) values (86,3,'VAT (17.5%)','17.5000','P','2011-03-09 21:17:10','2011-09-22 22:24:29'),(87,3,'Eco Tax (-2.00)','2.0000','F','2011-09-21 21:49:23','2011-09-23 00:40:19');
...
insert  into `tax_rate_to_customer_group`(`tax_rate_id`,`customer_group_id`) values (86,6),(86,8),(87,6),(87,8);
...
insert  into `tax_rule`(`tax_rule_id`,`tax_class_id`,`tax_rate_id`,`based`,`priority`) values (121,10,86,'payment',1),(120,10,87,'store',0),(128,9,86,'shipping',1),(127,9,87,'shipping',2);
...
insert  into `url_alias`(`url_alias_id`,`query`,`keyword`) values (704,'product_id=48','ipod_classic'),(773,'category_id=20','desktops'),(503,'category_id=26','pc'),(505,'category_id=27','mac'),(730,'manufacturer_id=8','apple'),(772,'information_id=4','about_us'),(768,'product_id=42','test'),(767,'category_id=34','mp3-players'),(536,'category_id=36','Normal');
...
insert  into `user`(`user_id`,`user_group_id`,`username`,`password`,`firstname`,`lastname`,`email`,`code`,`ip`,`status`,`date_added`) values (1,1,'admin','96e79218965eb72c92a549dd5a330112','','','horechek@gmail.com','','127.0.0.1',1,'2012-07-29 21:52:10');
...
/*Data for the table `user_users` */

insert  into `user_users`(`id`,`username`,`password`,`email`,`role`,`state`) values (1,'test1','pass1','test1@example.com',NULL,0),(2,'test2','pass2','test2@example.com',NULL,0),(3,'test3','pass3','test3@example.com',NULL,0),(4,'test4','pass4','test4@example.com',NULL,0),(5,'test5','pass5','test5@example.com',NULL,0),(6,'test6','pass6','test6@example.com',NULL,0),(7,'test7','pass7','test7@example.com',NULL,0),(8,'test8','pass8','test8@example.com',NULL,0),(9,'test9','pass9','test9@example.com',NULL,0),(10,'test10','pass10','test10@example.com',NULL,0),(11,'test11','pass11','test11@example.com',NULL,0),(12,'test12','pass12','test12@example.com',NULL,0),(13,'test13','pass13','test13@example.com',NULL,0),(14,'test14','pass14','test14@example.com',NULL,0),(15,'test15','pass15','test15@example.com',NULL,0),(16,'test16','pass16','test16@example.com',NULL,0),(17,'test17','pass17','test17@example.com',NULL,0),(18,'test18','pass18','test18@example.com',NULL,0),(19,'test19','pass19','test19@example.com',NULL,0),(20,'test20','pass20','test20@example.com',NULL,0),(21,'test21','pass21','test21@example.com',NULL,0),(22,'admin','96e79218965eb72c92a549dd5a330112','horechek@gmail.com','admin',0);
...
insert  into `voucher_theme`(`voucher_theme_id`,`image`) values (8,'data/canon_eos_5d_2.jpg'),(7,'data/gift-voucher-birthday.jpg'),(6,'data/apple_logo.jpg');
...
insert  into `zone_to_geo_zone`(`zone_to_geo_zone_id`,`country_id`,`zone_id`,`geo_zone_id`,`date_added`,`date_modified`) values (57,222,0,3,'2010-02-26 22:33:24','0000-00-00 00:00:00'),(65,222,0,4,'2010-12-15 15:18:13','0000-00-00 00:00:00');
